...
const SearchBox = () => {
  return (
    <div className="bg-white rounded-lg p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 text-black items-center justify-center gap-8 mt-4 sm:mt-12 w-[95%] sm:w-[80%]">
      {/* 1st search box */}
      <div className="flex items-center space-x-6 ">
        ...
        <div>
          ...
          <input
            ...
            className="outline-none border-none placeholder:text-gray-700"
          />
        </div>
      </div>
      {/* 2nd search box */}
